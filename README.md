...
|------|-------------|------|---------|:--------:|
| <a name="input_allowed_cidr_blocks"></a> [allowed\_cidr\_blocks](#input\_allowed\_cidr\_blocks) | Allow inbound ingress trafic from these cidr blocks. | `list(string)` | <pre>[<br>  "0.0.0.0/0"<br>]</pre> | no |
| <a name="input_allowed_security_group_ids"></a> [allowed\_security\_group\_ids](#input\_allowed\_security\_group\_ids) | Allow inbound ingress trafic from these security groups. | `list(string)` | `[]` | no |
...
| <a name="input_parameter_group_parameter_overrides_immediately"></a> [parameter\_group\_parameter\_overrides\_immediately](#input\_parameter\_group\_parameter\_overrides\_immediately) | Map of parameters to override default values. | `map(string)` | `{}` | no |
| <a name="input_parameter_group_parameter_overrides_on_reboot"></a> [parameter\_group\_parameter\_overrides\_on\_reboot](#input\_parameter\_group\_parameter\_overrides\_on\_reboot) | Map of parameters to override default values. | `map(string)` | `{}` | no |
